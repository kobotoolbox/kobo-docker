...
1. [Important notice when upgrading from commit `e2d3e82` (July 7, 2026) or earlier](#important-notice-when-upgrading-from-commit-e2d3e82-july-7-2026-or-later)
...
## Important notice when upgrading from commit `e2d3e82` (July 7, 2026) or later
